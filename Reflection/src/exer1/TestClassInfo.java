...
public class TestClassInfo {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * 0x是十六进制 PUBLIC = 0x00000001; 1 1 PRIVATE = 0x00000002; 2 10 PROTECTED
		 * = 0x00000004; 4 100 STATIC = 0x00000008; 8 1000 FINAL = 0x00000010;
		 * 16 10000 ...
		 *
		 * 设计的理念，就是用二进制的某一位是1，来代表一种修饰符，整个二进制中只有一 位是1，其余都是0
		 *
		 * mod = 17 0x00000011 if ((mod & PUBLIC) != 0) 说明修饰符中有public if ((mod &
		 * FINAL) != 0) 说明修饰符中有final
		 */
		...
		/*
		 * Field clazz.getField(name) 根据属性名获取一个属性对象，但是只能得到公共 的 Field[]
		 * clazz.getFields(); 获取所有公共的属性 Field clazz.getDeclaredField(name)
		 * 根据属性名获取一个属性对象，可以获 取已声明的 Field[] clazz.getDeclaredFields() 获取所有已声明的属性
		 */

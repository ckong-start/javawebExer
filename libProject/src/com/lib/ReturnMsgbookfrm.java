...
class ReturnMsgbookfrm extends JFrame implements ActionListener {
	...
	JButton b_clear, b_update, b_back, b_enter;
	...
	public void actionPerformed(ActionEvent ed) {
		...
		if (ed.getSource() == b_update) {
			...
			try {
				...
				// 更新用户信息
				String tem = "UPDATE bookbrowse SET username=" + a3 + ",bookname=" + a4 + ",returndata=" + a5 + ",memo="
						+ a2 + " WHERE username=" + a3;
				sqll.executeUpdate(tem);
				l_msg.setText("还书修改成功");
